...
- **Status**: pending
- **Spec**: `desktop-workspace-response-doc-authoring/` (requirements
  R-A-1..R-A-6, design, tasks)
...
| Panel tests | T2 | `vitest module-screens` — generate/save/regenerate/402/409/poll-stop | — |
