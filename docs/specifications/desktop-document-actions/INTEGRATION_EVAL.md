...
- [ ] HTTP allow-list remains exactly three entries.
- [ ] Existing single-document download behavior is unchanged.
- [ ] No government fallback or parent change was introduced.
