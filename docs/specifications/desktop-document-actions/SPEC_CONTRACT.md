...
| # | Item | Contract |
|---|---|---|
| T1 | Native foundation | Opener plugin + shared saved-path outcome + injectable temp-open/directory port; only directory picker and `$TEMP/tenders-sa/**` write/open-path capability expansion |
